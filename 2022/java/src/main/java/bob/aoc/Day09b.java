...
public class Day09b extends BaseClass<List<Day09Move>> {
    ...
    public void solve(List<Day09Move> moves) {
        ...
        Coord2D i1 = new Coord2D(0, 0);
        Coord2D i2 = new Coord2D(0, 0);
        Coord2D i3 = new Coord2D(0, 0);
        Coord2D i4 = new Coord2D(0, 0);
        Coord2D i5 = new Coord2D(0, 0);
        Coord2D i6 = new Coord2D(0, 0);
        Coord2D i7 = new Coord2D(0, 0);
        Coord2D i8 = new Coord2D(0, 0);
