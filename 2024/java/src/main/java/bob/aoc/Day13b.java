...
public class Day13b extends BaseClass<List<Day13Machine>> {
    ...
    public void solve(Day13Machine m) {
        ...
        Assert.that((pa > 0), "Push button A " + pa + " times?");
        ...
        m.pa = pa;
        m.pb = pb_num / pb_den;
        Assert.that((m.pb > 0), "Push button B " + m.pb + " times?");
    }
}
