...
public class Day13a extends BaseClass<TwoFormatParser.Output<List<Coord2D>, List<Day13Fold>>> {
    ...
    public void solve(TwoFormatParser.Output<List<Coord2D>, List<Day13Fold>> data) {
        ...
        LOG.info("Number of dots is {}", dots.size());
    }
